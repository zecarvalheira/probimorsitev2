...
$(window).bind('load', function () {
	...
	function parallaxInit() {
        $('#novidades-parallax').parallax("30%", 0.1);
		$('#twitter-parallax').parallax("30%", 0.1);
        $('#parallax').parallax("30%", 0.1);
        $('#parallax2').parallax("30%", 0.1);
        $('#parallax3').parallax("30%", 0.1);
...
//Google Map
	var latlng = new google.maps.LatLng(38.6492995,-8.2196927);
	var settings = {
		zoom: 16,
		center: new google.maps.LatLng(38.6492995,-8.2196927), mapTypeId: google.maps.MapTypeId.ROADMAP,
	...
	var contentString = '<div id="content">'+
		'<div id="siteNotice">'+
		'</div>'+
		'<h3 id="firstHeading" class="firstHeading">Probimor</h3>'+
		'<div id="bodyContent">'+
		'<p>Travessa da Cruz da Conceição nº 15, 7050-278 Montemor-o-Novo</p>'+
		'</div>'+
		'</div>';
	...
	var companyImage = new google.maps.MarkerImage(myThemePath + '/images/marker.png',
	...
	var companyPos = new google.maps.LatLng(38.6492995,-8.2196927);
